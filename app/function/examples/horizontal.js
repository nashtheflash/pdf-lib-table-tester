...
import { horizontalPageTableSettings } from '../../lib/horizontalPageSettings';
...
export class Horizontal {
    ...
    tableSettings({ data, columns, page, pdfDoc, primaryFont, secondaryFont }) {
        return horizontalPageTableSettings({ data, columns, page, pdfDoc, primaryFont, secondaryFont });
    }
